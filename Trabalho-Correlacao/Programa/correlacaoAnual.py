"""
Executamos uma copia do programa principal para cada ano
com um filtro para o respectivo ano anotamos as saidas
e jogamos num outro programa para plotar o gráfico
"""
...
#Filtros
df_editoracao = df_editoracao[df_editoracao['Ano Fase']==2016]
df_eventos = df_eventos[df_eventos[' Fase']==2016]
